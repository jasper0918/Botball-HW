(function(){function s(a){if("string"!==typeof a)return false;try{a=(JSON&&JSON.parse||function(a){return eval("("+a+")")})(a.replace(/[\u0000-\u001f]/g," "))}catch(b){return false}return a}function k(a,b,d){(new Image).src="http://badjs.qq.com/cgi-bin/js_report?level="+(d||4)+"&bid=176"+(b?"&mid="+b:"")+"&msg="+encodeURIComponent(a)+"|_|"+x+"|_|0"+y+"&r="+Math.random()}function m(){i&&(i=!c("Contact.IsOnline").online);return i}function t(a){i=!a;for(var b=0,d=g.length;b<d;b++)g[b](a)}function c(a,
b){var d;if(d=!a.match(z))m()&&"function"==typeof(u=j.OFFLINE_TIPS)&&u(),d=i;if(d)return false;d=A[a]||null;var c=true,e;if((e=B[a])&&e.t)0>=e.l||!e.l?e.b=+new Date+e.t:c=false,e.l=e.b-new Date;c&&d&&v(331058);if(e=window.external&&window.external.CallHummerApi){try{var n=e.apply(this,arguments)}catch(h){return c&&k("Incorrect Call by "+a+"("+b+") with Exception "+h.message,331059),false}j.ISREPORT&&d&&v(d.id);e=s(n);if(j.ISREPORT&&d&&d.e){var g;if("object"!=typeof e||e.errorCode)c&&k("Incorrect Data And ErrorCode by "+
a+"("+b+") with "+n,d.e);else if(g=d.c)for(var l in g)if(!(l in e)||""===e[l]||null===e[l]){c&&k("Incorrect Data by "+a+"("+b+") Property "+l+" with "+n,d.e);break}}return e}c&&k("Incorrect Call by "+a+" without Function CallHummerApi",331059);return false}function h(a,b,d){if("object"!=typeof a)return a;var b=b||{},c;for(c in b){var e,g;a[c]=d&&"function"===typeof(e=a[c])&&"function"===typeof(g=b[c])?function(){g.apply(a,arguments)||e.apply(a,arguments)}:b[c]}}var w=this||window,j=w.CommonApi||(w.CommonApi=
...
'", "fileSize" : "'+d+'" }')},openWebPic:function(a,b){q=b;return c("Misc.OpenWebPic",'{ "url" : "'+a+'", "function" : "OnOpenWebPicEvt" }')},clipScreen:function(a,b,d,f,e){r=e;return c("Misc.ClipScreen",'{ "url" : "'+d+'", "cookies" : "'+a+'", "parameters" : "'+b+'", "method" : "'+f+'", "uploaded" : "onClipScreenEvt" }')},onQQStateChange:function(a){"function"===typeof a&&g.push(a)},onCanCloseWindow:function(a){"function"===typeof a&&o.push(a)},onReceiveS2CMsg:function(a){"function"===typeof a&&
p.push(a)},extend:function(a,b,c,f){var e=Object.prototype.toString.call(a);"[object String]"===e?(e={},e[a]=b,h(c||this,e,f)):"[object Object]"===e&&((null===b||void 0===b)&&4<=arguments.length?c=c||this:(f=c,c=b||this),h(c,a,f))},OFFLINE_TIPS:function(){},ISREPORT:true})})();
