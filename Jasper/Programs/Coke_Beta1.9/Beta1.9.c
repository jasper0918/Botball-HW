...
// vision constant:
const int OFFSET_X = 65;	// standard x coordinate to catch a ball
const int OFFSET_Y = 44;	// standard y coordinate to catch a ball
const int P_X = 1;
const int P_Y = 1;
...
void moveToBalls(){
	...
	mrp(LM, LM_SP_STR2, -70);
	mrp(RM, RM_SP_STR2, -70);
	bmd(LM);
	bmd(RM);
	ao();
	//msleep(250);
